export const resources = {
  en: {
    translation: {
      ...
      exploreInternalTab: 'Internal',
      explorePublicTab: 'Public',
      internalLoading: 'Fetching skills from private repository...',
      internalEmpty: 'No skills found in private repository.',
      internalNotConfigured: 'Private source not configured. Go to Settings to set up.',
      internalImportSelected: 'Import Selected',
      internalRefresh: 'Refresh',
      internalInstalled: 'Installed',
      internalUpdateAvailable: 'Update',
      internalUpdate: 'Update',
      internalSelected: '{{count}} selected',
      internalImportSuccess: 'Imported {{count}} skill(s) successfully.',
      internalUpdateSuccess: '"{{name}}" updated.',
      privateSource: 'Private Source',
      privateSourceFolderUrl: 'Paste the repository URL. All skills inside will be discovered automatically.',
      privateSourceFolderUrlPlaceholder: 'https://git.example.com/owner/repo',
      privateSourceToken: 'Access Token',
      privateSourceTokenPlaceholder: 'personal access token',
      privateSourceParsed: 'Parsed → server: {{url}} · repo: {{repo}}',
      privateSourceParseError: 'Cannot parse this URL. Please paste the folder page URL from Gogs/Gitea.',
      privateSourceSave: 'Save',
      privateSourceTest: 'Test Connection',
      privateSourceSaved: 'Private source saved.',
      privateSourceTestOk: 'Connected as {{user}}.',
      privateSourceTestFail: 'Connection failed: {{error}}',
  ...
  zh: {
    translation: {
      ...
      exploreInternalTab: '内部',
      explorePublicTab: '公开',
      internalLoading: '正在从私有仓库拉取 Skills...',
      internalEmpty: '私有仓库中未找到 Skills。',
      internalNotConfigured: '未配置私有源，请前往设置页面进行配置。',
      internalImportSelected: '导入选中',
      internalRefresh: '刷新',
      internalInstalled: '已安装',
      internalUpdateAvailable: '有更新',
      internalUpdate: '更新',
      internalSelected: '已选 {{count}} 项',
      internalImportSuccess: '成功导入 {{count}} 个 Skill。',
      internalUpdateSuccess: '「{{name}}」已更新。',
      privateSource: '内部技能源',
      privateSourceFolderUrl: '粘贴仓库地址，系统将自动扫描全仓库找到所有 Skill。',
      privateSourceFolderUrlPlaceholder: 'https://git.example.com/owner/repo',
      privateSourceToken: '访问令牌',
      privateSourceTokenPlaceholder: '个人访问令牌',
      privateSourceParsed: '解析结果 → 服务器：{{url}} · 仓库：{{repo}}',
      privateSourceParseError: '无法解析此 URL，请粘贴 Gogs/Gitea 中的文件夹页面地址。',
      privateSourceSave: '保存',
      privateSourceTest: '测试连接',
      privateSourceSaved: '私有源配置已保存。',
      privateSourceTestOk: '连接成功，用户：{{user}}。',
      privateSourceTestFail: '连接失败：{{error}}',
